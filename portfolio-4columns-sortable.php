<?php
/**
 * Template name: Portfolio - Discover
 *
 */
...
?>
	<div class="one_half<?php if($i % 2 == 0) echo ' last'; ?> featuredcoll">
		<div class="portfolio-item" id="post-<?php the_ID(); ?>">
			...
			<div class="fancy_meta">
				<ul>
					...
					<li><a class="tiptip fancy_icon fancy_preview" href="<?php echo $portfolio_url; ?>" title="View All Items">View All Items</a></li>
